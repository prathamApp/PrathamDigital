package com.pratham.prathamdigital.custom.morphing;
...
public class MorphFabToDialog extends ChangeBounds {
    ...
    public void captureStartValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_COLOR, ContextCompat.getColor(view.getContext(), R.color.mustord_yellow));
    ...
    public void captureEndValues(TransitionValues transitionValues) {
        ...
        transitionValues.values.put(PROPERTY_COLOR, ContextCompat.getColor(view.getContext(), R.color.ghost_white));
        transitionValues.values.put(PROPERTY_CORNER_RADIUS, view.getResources().getDimensionPixelSize(R.dimen.size_5));
    }
